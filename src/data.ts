...
export const initialNewsletterData: NewsletterData = {
  ...
  testimonials: [
    {
      id: "test-1",
      quote:
        "The team at Infomate is willing to go 'above and beyond' when it comes to ensuring their deliverables are met (and normally exceeded). Infomate always work in a proactive manner to ensure an excellent service.",
    ...
    },
    {
      id: "test-2",
      quote:
        "Congratulations and thanks Infomate team for your relentless commitment to deliver our expectations. This very spirit worked absolutely well - you made the ride smooth for us. Let's take our partnership to its next level of excellence.",
    ...
    },
    {
      id: "test-3",
      quote:
        "We appreciate the hard work and commitment of the entire Infomate team and its management. We feel that our finance has an extended family at Infomate. Thank you for the excellent professional work you have done and looking forward to building efficacy and solidifying a great business partnership.",
  ...
  services: [
    {
      ...
      description:
        "Managing supply chain transactions seamlessly, securing payment timeliness, and optimizing working capital.",
      items: [
    ...
    },
    {
      ...
      description:
        "Accelerating your revenue cycle, minimizing sales friction, and protecting customer relationships with professional communications.",
      items: [
    ...
    },
    {
      ...
      description:
        "Ensuring flawless accounting, capitalization, and physical-to-financial reconciliation of corporate assets.",
      items: [
    ...
    },
    {
      ...
      description:
        "Transforming raw numbers into structured financial ledgers and actionable intelligence for your executive team.",
      items: [
    ...
    },
    {
      ...
      description:
        "Delivering advanced risk calculations, security checks, and high-level analytical modeling for financial products.",
      items: [
  ...
  backOffice: [
    {
      ...
      description:
        "Ensuring smooth international transit with flawless manifest entry and custom papers.",
      iconName: "Ship",
    },
    {
      id: "bo-2",
      ...
      description:
        "Rigorous customer verification and security checks to maintain regulatory compliance.",
    ...
    },
    {
      ...
      description:
        "Supporting sourcing, purchase requests, and transactional vendor communications.",
    ...
    },
    {
      ...
      description:
        "Serving as a single touchpoint for inquiries, processing tickets with high SLA speed.",
      iconName: "HelpCircle",
    },
    {
      id: "bo-5",
      title: "Call Centers",
      description:
        "Professional multi-lingual voice services supporting inbound and outbound calls.",
      iconName: "PhoneCall",
    },
    {
      id: "bo-6",
      ...
      description:
        "Conducting market qualification to fuel your active sales pipeline with targeted prospects.",
      iconName: "Target",
    },
    {
      id: "bo-7",
      ...
      description:
        "Delivering clean labels and structured schemas to fuel databases and AI models.",
      iconName: "FileText",
    },
    {
      id: "bo-8",
      ...
      description:
        "Drafting current state, standardizing SOPs, and engineering future-state workflows.",
      iconName: "GitMerge",
    },
    {
      id: "bo-9",
      ...
      description:
        "Processing employee logs, calculating payroll, and handling contract admin securely.",
      iconName: "Users",
    },
  ],
  team: [
  ...
  social: [
    {
      ...
      badge: "Education",
      description:
        "Infomate collaborates with Child Action Lanka, supporting projects that enhance the well-being and education of underprivileged children with an emphasis on career life skills and employment.",
      imageUrl:
    ...
    },
    {
      ...
      badge: "Employment",
      description:
        "Our pioneering Rural Business Process Outsourcing (BPO) initiative provides employment opportunities in rural areas, fostering local economic development and reducing the urban-rural divide.",
      imageUrl:
    ...
    },
    {
      ...
      badge: "Environment",
      description:
        "From career workshops for undergraduates to active participation in local beach cleanups and tree-planting drives, Infomate keeps sustainability and social responsibility at the core of our culture.",
      imageUrl:
        "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=600&q=80",
    },
  ],
  valueProps: [
    {
      ...
      description:
        "Drawing on two decades of process engineering to offer strategic workflow modifications.",
    },
    {
      number: 2,
      title: "Focus on Your Core Business",
      description:
        "We handle time-consuming, administrative, and repetitive tasks, freeing your team for strategic growth.",
    },
    {
      number: 3,
      title: "Highly Scalable Talent Pool",
      description:
        "Tap into an elastic team with immediate capacity adjustments to support seasonality and volume spikes.",
    },
    {
      number: 4,
      title: "Multi-Industry Cross-Pollination",
      description:
        "Benefiting from operational models tested across hotels, retail, finance, telecom, and healthcare.",
    },
    {
      number: 5,
      title: "Committed SLA & KPI Rigor",
      description:
        "Every process is strictly measured, documented, and reported through transparent monthly dashboard audits.",
    },
    {
      number: 6,
      title: "Backed by Sri Lanka's No.1 Corporate",
      description:
        "Backed by the multi-billion rupee strength, governance, and ethics of John Keells Holdings PLC (JKH).",
    },
    {
      number: 7,
      title: "Personalized Partner Attention",
      description:
        "We are an agile boutique-feel extended workforce, avoiding faceless giant bureaucracy.",
    },
    {
      number: 8,
      title: "Cost Efficiency & Variabilization",
      description:
        "Convert fixed staffing overheads into variable, transaction-linked costs to preserve cash flow.",
    },
  ],
  page3: {
    ...
    commentaryText:
      "Overall services exports shot up by 24.59% in early 2026, driven directly by a stunning 60.21% year-on-year surge in ICT and business process management services. Colombo remains the regional nucleus for specialized finance outsourcing.",
  ...
  page4: {
    ...
    trends: [
      {
        title: "The $256T Shadow Banking Shift",
        text: "Non-bank financial institutions (NBFIs) now manage over half of global financial assets, peaking at USD 256.8 Trillion. Higher leverage increases the demand for strict risk modeling and compliance auditing.",
      },
      {
        title: "Surging Private Credit",
        text: "Private credit continues to swell, matching USD 2.1 Trillion globally. CFOs seek rapid-origination capital to manage USD 620B of maturing corporate high-yield bonds due through 2027.",
      },
      {
        title: "Agentic AI as Operating System",
        text: "70% of financial firms have transitioned from basic pilots to agentic AI workflows. 16% are fully automated in key compliance lines, leveraging human-in-the-loop oversight to ensure strict ledger safety.",
      },
    ],
  ...
  page5: {
    ...
    projects: [
      {
        title: "CWIT Deep Terminal",
        text: "Strategic USD 840M port project in Colombo handling over 717,000 TEUs in its debut year.",
      },
      {
        title: "Cinnamon Life mixed-use",
        text: "Colombo's landmark luxury destination, transforming regional luxury tourism and gaming/leisure.",
      },
      {
        title: "BYD New Energy Vehicles",
        text: "Strong partnership launched to spearhead sustainable EV vehicle distribution.",
      },
    ],
    commitmentsTitle: "Carbon & Environment Commitments",
    commitmentsText:
      "John Keells Holdings' commitment to sustainability translates directly to Infomate. Across our combined operations, carbon footprint per million rupees of revenue declined by 8.3%, and water withdrawal declined by 9.5% over the fiscal quarters.",
  ...
  page11: {
    ...
    description:
      "At Infomate, we believe in fostering a vibrant, supportive, and healthy workplace. Here is a look at some of our recent health, career, and community initiatives.",
    ...
    tagline:
      "Inspiring our smart extended workforce to prioritize well-being and community.",
    ...
    wellnessItems: [
      {
        ...
        description:
          "Insightful NCD prevention and stress recovery sessions promoting 360-degree holistic physical and mental health for our staff.",
        imageUrl: "/wellness_session.jpg",
      },
      {
        id: "w2",
        ...
        description:
          "Our team brought incredible energy to the stage, celebrating friendship and fun with power ballads and solo spotlights.",
      ...
      },
      {
        ...
        description:
          "Celebrating International Women's Day 2026 with an inspiring panel on challenges, choices, and confidence.",
      ...
      },
      {
        ...
        description:
          "Sharing advice on continuous learning, resilience, and personal growth to craft meaningful careers.",
      ...
      },
      {
        ...
        description:
          "Creating beautiful displays of traditional paper and wood lanterns to transform our workspace in the spirit of Vesak.",
      ...
      },
      {
        ...
        description:
          "Generous popsicle and kimbula bun dansalas hosted by Team Pagero and the Ultimate Finance Team.",
  ...
  page12: {
    ...
    description:
      "Love was in the air everywhere we turned… and so were the high notes!",
    highlights:
      "Our Valentine’s Day Karaoke Evening at Infomate turned into a stage full of stars! From power ballads to classic sing-alongs and everyone’s all-time favorite hits, the evening was filled with laughter, music, and unforgettable performances. Whether hitting the high notes perfectly or just singing their hearts out, our team truly brought the energy and vibes.",
    tagline:
      "More than just karaoke - a celebration of fun, friendship, and fearless singing!",
    imageUrl: "",
    imageHeight: 200,
    imageWidth: 40,
    imagePosition: "left",
    ...
    wellnessItems: [
      {
        ...
        description:
          "Teams paired up to perform legendary rock ballads and current chart-topping pop duets.",
        imageUrl: "",
      },
      {
        id: "k2",
        ...
        description:
          "Everyone joined in for massive group performances of classic hits, filling the room with laughter.",
        imageUrl: "",
      },
      {
        id: "k3",
        ...
        description:
          "Our hidden talents took center stage, delivering emotional, pitch-perfect solo performances.",
        imageUrl: "",
      },
    ],
  },
  page13: {
    ...
    description:
      "In celebration of International Women’s Day 2026, Infomate organized an engaging panel discussion titled “Navigating Career Growth as a Woman: Challenges, Choices & Confidence.”",
    panelTitle: "Navigating Career Growth as a Woman",
    panelText:
      "The session brought together inspiring female leaders and male leaders who shared their personal career journeys, the challenges they have encountered, and the choices that have shaped their professional growth. Through open and insightful discussions, the panel encouraged participants to embrace confidence, pursue opportunities, and support one another in their career paths.",
    tagline:
      "Empowering women and fostering inclusive workplaces where individuals can grow and thrive.",
    imageUrl: "",
    imageHeight: 192,
    imageWidth: 35,
    imagePosition: "right",
    ...
    wellnessItems: [
      {
        ...
        description:
          "Exploring critical decision points, career pivots, and finding balance in corporate leadership.",
        imageUrl: "",
      },
      {
        id: "d2",
        ...
        description:
          "Panelists shared personal strategies for handling career roadblocks, glass ceilings, and bias.",
        imageUrl: "",
      },
      {
        id: "d3",
        ...
        description:
          "Fostering assertiveness, self-advocacy, and empowering mentorship networks inside Infomate.",
        imageUrl: "",
      },
    ],
  },
  page14: {
    ...
    description:
      "We kicked off the first MATE Talk Series for the year with an inspiring and thought-provoking panel discussion on “Beyond the Ladder: Crafting Meaningful Careers.”",
    speaker1Name: "Yolan Seimon",
    speaker1Title: "Head of Data and Advanced Analytics, OCTAVE",
    speaker1Desc:
      "Yolan's journey from an intern to leading Data and Advanced Analytics at OCTAVE shows the power of continuous learning.",
    speaker2Name: "Yasasi Perera",
    speaker2Title:
      "Assistant Director – Finance, Cinnamon Life Integrated Resort",
    speaker2Desc:
      "Yasasi's progression from a non-executive role to Assistant Director demonstrates resilience and dedication.",
    takeaway:
    ...
    wellnessItems: [
      {
        ...
        description:
          "Highlighting career progression from intern to Head of Advanced Analytics at OCTAVE.",
        imageUrl: "",
      },
      {
        id: "m2",
        ...
        description:
          "Fostering professional dedication and moving from executive roles to Assistant Director of Finance.",
        imageUrl: "",
      },
      {
        id: "m3",
        ...
        description:
          "Reflecting on personal development, flexibility, and defining success outside traditional ladders.",
        imageUrl: "",
      },
    ],
  },
  page15: {
    ...
    description:
      "In celebration of Vesak, Infomate organized an engaging Vesak Decoration Competition across our office floors, encouraging teams to showcase their creativity while embracing the spirit of the season.",
    details:
      "The initiative brought employees together to design and decorate their respective spaces with meaningful Vesak themes, reflecting values of peace, compassion, and togetherness. From traditional lanterns and thematic displays to thoughtfully crafted decorations, each team contributed to making the celebration truly special and transforming their floors into vibrant displays of cultural artistry.",
    tagline:
      "Strengthening team spirit, collaboration, and cultural appreciation among employees.",
    imageUrl: "/vesak_decoration.jpg",
    imageHeight: 192,
    imageWidth: 40,
    imagePosition: "right",
    ...
    wellnessItems: [
      {
        ...
        description:
          "Floors decorated in traditional Vesak styles, highlighting peaceful cultural themes.",
        imageUrl: "/vesak_decoration.jpg",
      },
      {
        id: "v2",
        ...
        description:
          "Teams collaborated to craft handmade paper and wood lanterns to display in the main lobbies.",
        imageUrl: "",
      },
      {
        id: "v3",
        ...
        description:
          "Exhibiting traditional paintings and visual displays reflecting compassion and unity.",
        imageUrl: "",
      },
    ],
  },
  page16: {
    ...
    description:
      "As part of the Vesak celebrations, Infomate employees came together to embrace the spirit of generosity, sharing, and community through two special Dansala initiatives.",
    teamPageroText:
      "Team Pagero organized a refreshing Popsicle Ice Cream Dansala, sharing refreshing treats to bring a festive and welcoming atmosphere.",
    teamFinanceText:
      "The Ultimate Finance Team hosted a traditional Kimbula Bun Dansala, creating opportunities for employees to experience the joy of giving and togetherness.",
    tagline:
      "A wonderful reminder of the importance of giving back and coming together as one Infomate family.",
    imageUrl: "/vesak_dansala.jpg",
    imageHeight: 192,
    imageWidth: 40,
    imagePosition: "right",
    ...
    wellnessItems: [
      {
        ...
        description:
          "Hosted by Team Pagero, sharing refreshing treats to spread joy and build closer community bonds.",
        imageUrl: "/vesak_dansala.jpg",
      },
      {
        id: "d2",
        ...
        description:
          "Hosted by the Ultimate Finance Team, serving hot traditional buns to office building staff.",
        imageUrl: "",
      },
      {
        id: "d3",
        ...
        description:
          "Coming together to experience the joy of volunteering, generosity, and active sharing.",
        imageUrl: "",
      },
    ],
  },
